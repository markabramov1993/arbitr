# Current earning priority — audited 2026-09-10

1. **CONFIRMED first:** preserve the already-settled **5.0 RTC** from BoTTube/RustChain #1102. This is real seed capital, but native RTC remains ring-fenced until a public/user-accessible conversion route, liquidity, gas and slippage are verified.
2. **Repeat the proven payer without violating caps:** #1102 second/final functional bug (mobile login does not validate API key) is already submitted for 5 RTC. Await review; cap 2 means no further #1102 claims from this contributor.
3. **Convert existing small claims into receipts:** #13949 (2 RTC), #1575 (3–5 RTC canonical), #1579 (3 RTC), #100 (2 RTC). They are already submitted; monitor rather than duplicate.
